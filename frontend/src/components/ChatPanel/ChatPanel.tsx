...
// ----------------------------------------------------------------
// Chat toggle button (fixed to bottom-right) with floating popup
// ----------------------------------------------------------------
export function ChatToggleButton() {
  ...
  // Show the popup bubble 1.6s after load if the chat is not open
  useEffect(() => {
    const timer = setTimeout(() => {
      if (!chatOpen && !dismissed) {
  ...
  return (
    <>
      {/* Speech Bubble Popup next to chatbot toggle button */}
      {!chatOpen && bubbleVisible && !dismissed && (
        <div
          role="dialog"
          aria-label="CitySense AI prompt"
          ...
          style={{
            ...
            padding: '9px 13px',
            borderRadius: 12,
            background: 'linear-gradient(135deg, rgba(6, 20, 48, 0.95) 0%, rgba(2, 10, 26, 0.95) 100%)',
            border: '1px solid rgba(0, 212, 255, 0.35)',
            boxShadow: '0 12px 32px rgba(0, 4, 16, 0.7), 0 0 16px rgba(0, 212, 255, 0.15)',
            backdropFilter: 'blur(16px)',
            cursor: 'pointer',
            maxWidth: 280,
          ...
          onMouseEnter={(e) => {
            e.currentTarget.style.borderColor = 'rgba(0, 220, 255, 0.7)'
            e.currentTarget.style.boxShadow = '0 14px 36px rgba(0, 4, 16, 0.8), 0 0 22px rgba(0, 212, 255, 0.28)'
          }}
          onMouseLeave={(e) => {
            e.currentTarget.style.borderColor = 'rgba(0, 212, 255, 0.35)'
            e.currentTarget.style.boxShadow = '0 12px 32px rgba(0, 4, 16, 0.7), 0 0 16px rgba(0, 212, 255, 0.15)'
          }}
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
            ...
            >
              Ask about heat, flood risks & planning.
            </div>
          </div>
          ...
          {/* Subtle tail pointing to chatbot icon */}
          <div
            style={{
              position: 'absolute',
              right: -6,
